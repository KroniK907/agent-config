...
4. **Follow Decisions** - task **Decisions** list IDs. Load the binding paragraphs with `go run <wayfinder>/utilities/wf/wf.go log <log-num> --ids ...` and constraints with `--global`. Scope to **Done when**.
